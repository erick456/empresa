            ...
            <ul id="side-nav" class="side-nav">
                ...
                <li class="panel ">
                    ...
                    <ul id="forms-collapse" class="panel-collapse collapse ">
                        <li class=""><a  href="<?php echo site_url("Cliente_controlador")?>">Clientes</a></li>
                ...
                <li class="panel ">
                    <a class="accordion-toggle collapsed" data-toggle="collapse"
                       data-parent="#side-nav" href="#stats-collapse"><i class="fa fa-area-chart"></i> <span class="name">Seguridad</span></a>
                    <ul id="stats-collapse" class="panel-collapse collapse ">
                        <li class=""><a href="<?php echo site_url("Perfil_controlador") ?>">Perfil</a></li>
                        <li class=""><a href="<?php echo site_url("Modulos_controlador") ?>">Modulos</a></li>
                        <li class=""><a href="<?php echo site_url("Permisos_controlador") ?>">Permisos</a></li>
                        <li class=""><a href="<?php echo site_url("Empleados_controlador") ?>">Empleados</a></li>
                    </ul>
                </li>
                <li class="panel ">
                    <a class="accordion-toggle collapsed" data-toggle="collapse"
                ...
                <li class="panel ">
                    ...
                    <ul id="special-collapse" class="panel-collapse collapse ">
                        ...
                        <li><a href="http://demo.flatlogic.com/3.3.1/dark/landing.html" data-no-pjax>Landing</a></li>
                        <li><a href="http://demo.flatlogic.com/3.3.1/dark/index.html" data-no-pjax title="Light Blue Transparent Dark version">Dark <sup class="text-warning fw-bold">new</sup></a></li>
                        <li><a href="http://demo.flatlogic.com/3.3.1/light/index.html" data-no-pjax title="Light Blue Transparent Light version">Light <sup class="text-warning fw-bold">new</sup></a></li>
                    </ul>
                </li>
                <li class="panel">
                    <a class="accordion-toggle collapsed" data-toggle="collapse"
