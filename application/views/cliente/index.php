                    ...
                    <div class="wrap">
                     ...
                     <div class="content container">
                      <section class="widget">
                        <header>
                            <h4>Clientes <span class="fw-semi-bold"></span></h4>
                            ...
                            <table id="datatable-table" class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Nombre</th>
                                        <th class="no-sort hidden-xs">Apellido</th>
                                ...
                                <tbody id="informacion">
                                    ...
                                    foreach ($clientes as $key => $value) {
                                        ...
                                        echo '<td><button onclick="modificar_cliente('.$value->id_cliente.')" type="button" class="btn btn-primary"
                                        data-placement="top" data-original-title=".btn .btn-primary">
                                        Modificar
                                    </button>
                                </td>';
                                echo '<td> <button onclick ="eliminar_cliente('.$value->id_cliente.')" type="button" class="btn btn-danger"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name='cliente_insert' class="form-horizontal" role="form">
                                <legend class="section">Registrar  Cliente</legend>
                                    <div class="form-group">
                                        <input type="hidden" name="id_cliente" value="">
                                        <label for="normal-field" class="col-sm-4 control-label">Nombre</label>
                                        <div class="col-sm-7">
                                            <input  name='nombre' type="text" id="normal-field" class="form-control" placeholder="Ingrese su nombre">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="apellido" type="text" id="hint-field" class="form-control" placeholder="Ingrese su apellido">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="tooltip-enabled">Telefono</label>
                                        <div class="col-sm-7">
                                            <input name="telefono" type="text" id="tooltip-enabled" class="form-control"
                        ...
                        <div class="modal-footer">
                            ...
                            <button onclick="guardar_cliente()" type="button" class="btn btn-primary">Guardar</button>
                        </div>
...
<?php include('public/app/cliente.php'); ?>
