                    ...
                    <div class="wrap">
                     ...
                     <div class="content container">
                      <section class="widget">
                        <header>
                            <h4>Perfiles <span class="fw-semi-bold"></span></h4>
                            ...
                            <table id="datatable-table" class="table table-striped table-hover">
                                ...
                                <tbody id="informacion">
                                    ...
                                    foreach ($perfil as $key => $value) {
                                        ...
                                        echo '<td><button onclick="modificar_perfil('.$value->id_perfil.')" type="button" class="btn btn-primary"
                                        data-placement="top" data-original-title=".btn .btn-primary">
                                        Modificar
                                    </button>
                                </td>';
                                echo '<td> <button onclick ="eliminar_perfil('.$value->id_perfil.')" type="button" class="btn btn-danger"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name='perfil_insert' class="form-horizontal" role="form">
                                <legend class="section">Registrar  Perfil</legend>
                                    <div class="form-group">
                                        <input type="hidden" name="id_perfil" value="">
                                        <label for="normal-field" class="col-sm-4 control-label">Descripcion</label>
                                        <div class="col-sm-7">
                                            <input  name='descripcion' type="text" id="normal-field" class="form-control" placeholder="Ingrese el perfil">
                        ...
                        <div class="modal-footer">
                            ...
                            <button onclick="guardar_perfil()" type="button" class="btn btn-primary">Guardar</button>
                        </div>
...
<?php include('public/app/perfil.php'); ?>
