                    ...
                    <div class="wrap">
                     ...
                     <div class="content container">
                      <section class="widget">
                        <header>
                            <h4>Empleados <span class="fw-semi-bold"></span></h4>
                            ...
                            <table id="datatable-table" class="table table-striped table-hover">
                                ...
                                <tbody id="informacion">
                                    ...
                                    foreach ($empleados as $key => $value) {
                                        ...
                                        echo '<td><button onclick="modificar_empleados('.$value->id_empleado.')" type="button" class="btn btn-primary"
                                        data-placement="top" data-original-title=".btn .btn-primary">
                                        Modificar
                                    </button>
                                </td>';
                                echo '<td> <button onclick ="eliminar_empleados('.$value->id_empleado.')" type="button" class="btn btn-danger"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name='empleado_insert' class="form-horizontal" role="form">
                                <legend class="section">Registrar  Empleado</legend>
                                    <div class="form-group">
                                        <input type="hidden" name="id_empleado" value="">
                                        <label for="normal-field" class="col-sm-4 control-label">Nombre</label>
                                        <div class="col-sm-7">
                                            <input  name='nombre' type="text" id="normal-field" class="form-control" placeholder="Ingrese  nombre">
                                            <div id="msg_empleado"></div>
                                        </div>
                                    </div>

                                   <div class="form-group">
                                        <label class="col-sm-4 control-label" for="tooltip-enabled">Apellidos</label>
                                        <div class="col-sm-7">
                                            <input name="apellido" type="text" id="tooltip-enabled" class="form-control"
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-4 control-label" for="tooltip-enabled">DNI</label>
                                        <div class="col-sm-7">
                                            <input name="dni" type="text" id="tooltip-enabled" class="form-control"
                                            data-placement="top" data-original-title="Some explanation text here"
                                            placeholder="ingrese el numeor de dni">
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button onclick="guardar_empleados()" type="button" class="btn btn-primary">Guardar</button>
                        </div>
...
<?php include('public/app/empleados.php'); ?>
